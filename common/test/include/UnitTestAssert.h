...
#define ASSERT_INT8_EQUAL(actual, expected)                                                                               \
    {                                                                                                                     \
        ...
        snprintf_(temp, ASSERT_MESSAGE_LENGTH, "Expected: %" PRId8 ", Actual: %" PRId8, (int8_t)expected, (int8_t)actual); \
...
#define ASSERT_INT16_EQUAL(actual, expected)                                                                                  \
    {                                                                                                                         \
        char temp[ASSERT_MESSAGE_LENGTH];                                                                                     \
        snprintf_(temp, ASSERT_MESSAGE_LENGTH, "Expected: %" PRId16 ", Actual: %" PRId16, (int16_t)expected, (int16_t)actual); \
...
#define ASSERT_INT32_EQUAL(actual, expected)                                                                                  \
    {                                                                                                                         \
        char temp[ASSERT_MESSAGE_LENGTH];                                                                                     \
        snprintf_(temp, ASSERT_MESSAGE_LENGTH, "Expected: %" PRId32 ", Actual: %" PRId32, (int32_t)expected, (int32_t)actual); \
...
#define ASSERT_INT64_EQUAL(actual, expected)                                                                                  \
    {                                                                                                                         \
        char temp[ASSERT_MESSAGE_LENGTH];                                                                                     \
        snprintf_(temp, ASSERT_MESSAGE_LENGTH, "Expected: %" PRId64 ", Actual: %" PRId64, (int64_t)expected, (int64_t)actual); \
...
#define ASSERT_UINT8_EQUAL(actual, expected)                                                                                \
    {                                                                                                                       \
        char temp[ASSERT_MESSAGE_LENGTH];                                                                                   \
        snprintf_(temp, ASSERT_MESSAGE_LENGTH, "Expected: %" PRIu8 ", Actual: %" PRIu8, (uint8_t)expected, (uint8_t)actual); \
...
#define ASSERT_UINT16_EQUAL(actual, expected)                                                                                   \
    {                                                                                                                           \
        char temp[ASSERT_MESSAGE_LENGTH];                                                                                       \
        snprintf_(temp, ASSERT_MESSAGE_LENGTH, "Expected: %" PRIu16 ", Actual: %" PRIu16, (uint16_t)expected, (uint16_t)actual); \
...
#define ASSERT_UINT32_EQUAL(actual, expected)                                                                                   \
    {                                                                                                                           \
        char temp[ASSERT_MESSAGE_LENGTH];                                                                                       \
        snprintf_(temp, ASSERT_MESSAGE_LENGTH, "Expected: %" PRIu32 ", Actual: %" PRIu32, (uint32_t)expected, (uint32_t)actual); \
...
#define ASSERT_UINT64_EQUAL(actual, expected)                                                                                   \
    {                                                                                                                           \
        char temp[ASSERT_MESSAGE_LENGTH];                                                                                       \
        snprintf_(temp, ASSERT_MESSAGE_LENGTH, "Expected: %" PRIu64 ", Actual: %" PRIu64, (uint64_t)expected, (uint64_t)actual); \
...
#define ASSERT_HEX8_EQUAL(actual, expected)                                                                                     \
    {                                                                                                                           \
        char temp[ASSERT_MESSAGE_LENGTH];                                                                                       \
        snprintf_(temp, ASSERT_MESSAGE_LENGTH, "Expected: 0x%" PRIx8 ", Actual: 0x%" PRIx8, (uint8_t)expected, (uint8_t)actual); \
        assert(((void *)0u), ((uint8_t)actual == (uint8_t)expected), __FILE__, __LINE__, temp);                                 \
    }
...
#define ASSERT_HEX16_EQUAL(actual, expected)                                                                                        \
    {                                                                                                                               \
        char temp[ASSERT_MESSAGE_LENGTH];                                                                                           \
        snprintf_(temp, ASSERT_MESSAGE_LENGTH, "Expected: 0x%" PRIx16 ", Actual: 0x%" PRIx16, (uint16_t)expected, (uint16_t)actual); \
        assert(((void *)0u), ((uint16_t)actual == (uint16_t)expected), __FILE__, __LINE__, temp);                                   \
    }
...
#define ASSERT_HEX32_EQUAL(actual, expected)                                                                                        \
    {                                                                                                                               \
        char temp[ASSERT_MESSAGE_LENGTH];                                                                                           \
        snprintf_(temp, ASSERT_MESSAGE_LENGTH, "Expected: 0x%" PRIx32 ", Actual: 0x%" PRIx32, (uint32_t)expected, (uint32_t)actual); \
        assert(((void *)0u), ((uint32_t)actual == (uint32_t)expected), __FILE__, __LINE__, temp);                                   \
    }
...
#define ASSERT_HEX64_EQUAL(actual, expected)                                                                                        \
    {                                                                                                                               \
        char temp[ASSERT_MESSAGE_LENGTH];                                                                                           \
        snprintf_(temp, ASSERT_MESSAGE_LENGTH, "Expected: 0x%" PRIx64 ", Actual: 0x%" PRIx64, (uint64_t)expected, (uint64_t)actual); \
        assert(((void *)0u), ((uint64_t)actual == (uint64_t)expected), __FILE__, __LINE__, temp);                                   \
    }
...
#define ASSERT_FLOAT_EQUAL(actual, expected, tolerance)                                                                                                                   \
    {                                                                                                                                                                     \
        char temp[ASSERT_MESSAGE_LENGTH];                                                                                                                                 \
        snprintf_(temp, ASSERT_MESSAGE_LENGTH, "Expected: %f, Actual: %f", (float)expected, (float)actual);                                                                \
...
#define ASSERT_DOUBLE_EQUAL(actual, expected, tolerance)                                                                                                                        \
    {                                                                                                                                                                           \
        char temp[ASSERT_MESSAGE_LENGTH];                                                                                                                                       \
        snprintf_(temp, ASSERT_MESSAGE_LENGTH, "Expected: %lf, Actual: %lf", (double)expected, (double)actual);                                                                  \
...
#define ASSERT_NULL(actual)                                                                  \
    {                                                                                        \
        char temp[ASSERT_MESSAGE_LENGTH];                                                    \
        snprintf_(temp, ASSERT_MESSAGE_LENGTH, "Expected: NULL, Actual: %p", (void *)actual); \
...
#define ASSERT_NOT_NULL(actual)                                                                  \
    {                                                                                            \
        char temp[ASSERT_MESSAGE_LENGTH];                                                        \
        snprintf_(temp, ASSERT_MESSAGE_LENGTH, "Expected: NOT NULL, Actual: %p", (void *)actual); \
        assert(((void *)0u), ((void *)actual != ((void *)0u)), __FILE__, __LINE__, temp);        \
    }
...
#define ASSERT_STRING_EQUAL(actual, expected, maxlength)                                                                     \
    {                                                                                                                        \
        char temp[ASSERT_MESSAGE_LENGTH];                                                                                    \
        snprintf_(temp, ASSERT_MESSAGE_LENGTH, "Expected: %s, Actual: %s", (char *)expected, (char *)actual);                 \
