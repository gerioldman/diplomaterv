...
\newcommand{\vikszerzoVezeteknev}{Krisztián}
\newcommand{\vikszerzoKeresztnev}{Gergő}

\newcommand{\vikkonzulensAMegszolitas}{}
\newcommand{\vikkonzulensAVezeteknev}{Hartmann}
\newcommand{\vikkonzulensAKeresztnev}{Ábel Miklós}
...
\newcommand{\vikcim}{Unit test futtatókörnyezet fejlesztése beágyazott rendszerekhez} % Cím
